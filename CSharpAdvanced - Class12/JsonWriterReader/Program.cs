...
namespace JsonWriterReader
{
    class Program {
        ...
        static void Main(string[] args) { 
            ...
            string path = @"C:\Users\igor.mitevski\Desktop\IGOR M\myRepoGIT\CSharpAdvanced - Class12\videogames.json";

            // Write JSON directly to a file
            File.WriteAllText(path, videogameRatings.ToString()); 

            //write JSON with JsonTextWriter
            path = @"C:\Users\igor.mitevski\Desktop\IGOR M\myRepoGIT\CSharpAdvanced - Class12\videogames2.json";
            ...
            path = @"C:\Users\igor.mitevski\Desktop\IGOR M\myRepoGIT\CSharpAdvanced - Class12\JsonPersonsWritten.json";
